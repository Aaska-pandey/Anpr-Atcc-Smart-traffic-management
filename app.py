...
def accident_detection():
    ...
    try:
        ...
        model_path = r"D:\anpr\ANPR-and-ATCC-for-Smart-Traffic-Management-main (3)\ANPR-and-ATCC-for-Smart-Traffic-Management-main\models\best.pt"  # Use your YOLO model path
