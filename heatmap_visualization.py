...
if __name__ == "__main__":
    video_path = [r"D:\anpr\ANPR-and-ATCC-for-Smart-Traffic-Management-main (3)\ANPR-and-ATCC-for-Smart-Traffic-Management-main\sample video file\heatmap_visualization.mp4"]
