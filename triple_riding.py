...
# Input video path
if __name__=="_main_":
    video_path = r"D:\anpr\ANPR-and-ATCC-for-Smart-Traffic-Management-main (3)\ANPR-and-ATCC-for-Smart-Traffic-Management-main\sample video file\triple_riding.mp4"
